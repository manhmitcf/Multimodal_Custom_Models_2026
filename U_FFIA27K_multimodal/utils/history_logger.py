...
class HistoryLogger:
    ...
    def save_detailed_evaluation_report(
        ...
        self._write_single_branch_report(
            ...
            branch_name="Audio Auxiliary Head (AudioFilterbankCRNN 256k)",
            split_name="Validation",
        ...
        content = [
            ...
            "\n[1.3] AUDIO AUXILIARY HEAD (AudioFilterbankCRNN 256 kHz)",
            ...
            "\n[2.3] AUDIO AUXILIARY HEAD (AudioFilterbankCRNN 256 kHz)",
