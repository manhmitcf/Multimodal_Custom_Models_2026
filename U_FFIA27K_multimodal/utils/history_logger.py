...
class HistoryLogger:
    ...
    def save_detailed_evaluation_report(
        ...
        self._write_single_branch_report(
            ...
            branch_name="Audio Auxiliary Head (ConvNeXt-1D Spectral 256k)",
            split_name="Validation",
        ...
        content.extend([
            ...
            "\n[1.3] AUDIO AUXILIARY HEAD (ConvNeXt-1D Spectral 256 kHz)",
            ...
            "\n[2.3] AUDIO AUXILIARY HEAD (ConvNeXt-1D Spectral 256 kHz)",
