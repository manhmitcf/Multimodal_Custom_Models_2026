...
class STFT_APE(STFT):
    ...
    def forward(self, input):
        """
        Calculate STFT of batch of signals with TKEO Adaptive Pre-Emphasis.
        
        Args:
            input: (batch_size, data_length), raw input waveforms.
        ...
        if self.alpha_max > 0:
            ...
            alpha_prev = torch.zeros(input.size(0), 1, device=input.device)
