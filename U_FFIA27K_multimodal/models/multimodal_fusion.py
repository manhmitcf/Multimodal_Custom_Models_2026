...
class PairwiseBoundaryTournamentHead(nn.Module):
    """
    Hierarchical Pairwise Cross-Boundary Tournament Head with 3 Configurable Audio STFT Tie-Breakers (~168K params).
    ...
    Level 2: 3-Way Pairwise Cross-Boundary Tournament with 3 Audio STFT Tie-Breakers
      - B12: Weak <-> Medium    -> Base Head on f_joint + Audio STFT Referee on f_audio
      - B23: Medium <-> Strong  -> Base Head on f_joint + Audio STFT Referee on f_audio
      - B13: Weak <-> Strong    -> Base Head on f_joint + Audio STFT Referee on f_audio
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Level 2: 3 Specialized Pairwise Subspace Heads + Audio Tie-Breakers
        # B12: Weak vs Medium
