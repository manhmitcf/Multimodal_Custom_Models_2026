...
class ArtifactUploadConfig(BaseModel):
    ...
    zip_path: str = Field(
        default="/marimo/Results_exp_audio_spectral_convnext1d_no_tie_breakers.zip",
        description="Path of the zip file to create."
    )
    repo_id: str = Field(
        default="manhmitcf/Results_exp_audio_spectral_convnext1d_no_tie_breakers",
    ...
    path_in_repo: str = Field(
        default="Results_exp_audio_spectral_convnext1d_no_tie_breakers.zip",
