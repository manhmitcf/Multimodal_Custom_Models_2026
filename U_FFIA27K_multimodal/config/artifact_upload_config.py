...
class ArtifactUploadConfig(BaseModel):
    ...
    zip_path: str = Field(
        default="/marimo/Results_ablation_video_tie_breakers.zip",
        description="Path of the zip file to create."
    )
    repo_id: str = Field(
        default="manhmitcf/Results_ablation_video_tie_breakers",
    ...
    path_in_repo: str = Field(
        default="Results_ablation_video_tie_breakers.zip",
