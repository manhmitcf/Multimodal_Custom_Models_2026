...
class ArtifactUploadConfig(BaseModel):
    ...
    zip_path: str = Field(
        default="/marimo/Results_exp_convnext_droppath_linear.zip",
        description="Path of the zip file to create."
    )
    repo_id: str = Field(
        default="manhmitcf/Results_exp_convnext_droppath_linear",
    ...
    path_in_repo: str = Field(
        default="Results_exp_convnext_droppath_linear.zip",
