...
class ArtifactUploadConfig(BaseModel):
    ...
    zip_path: str = Field(
        default="/marimo/Results_main_architecture_flat_4class_round_robin.zip",
        description="Path of the zip file to create."
    )
    repo_id: str = Field(
        default="manhmitcf/Results_main_architecture_flat_4class_round_robin",
    ...
    path_in_repo: str = Field(
        default="Results_main_architecture_flat_4class_round_robin.zip",
