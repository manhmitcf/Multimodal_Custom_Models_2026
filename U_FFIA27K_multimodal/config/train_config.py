...
class TrainConfig(BaseModel):
    ...
    phase2_backbone_mode: str = Field(default="unfreeze_last_stages", description="Phase 2 backbone strategy: 'freeze_all' (freeze both backbones completely, train only fusion), 'unfreeze_last_stages' (freeze stems/early stages, only unfreeze last stages), or 'unfreeze_all'.")
