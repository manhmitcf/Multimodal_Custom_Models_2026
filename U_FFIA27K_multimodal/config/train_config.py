...
class TrainConfig(BaseModel):
    ...
    kd_alpha_video: float = Field(default=0.5, ge=0.0, le=1.0, description="KD loss weight alpha for video.")
    kd_alpha_audio: float = Field(default=0.5, ge=0.0, le=1.0, description="KD loss weight alpha for audio.")
