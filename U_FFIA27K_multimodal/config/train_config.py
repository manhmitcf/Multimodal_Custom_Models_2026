...
class TrainConfig(BaseModel):
    ...
    kd_alpha_video: float = Field(default=0.65, ge=0.0, le=1.0, description="KD loss weight alpha for video (35% CE / 65% KD).")
    kd_alpha_audio: float = Field(default=0.65, ge=0.0, le=1.0, description="KD loss weight alpha for audio (35% CE / 65% KD).")
